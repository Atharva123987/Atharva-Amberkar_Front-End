    ...
    <ul style={{ textAlign: 'left' }}>
      {items.map((item, index) => (
        <SingleListItem
          ...
          key={index} // Optimization 1 : Passing a key for letting react know which items have changed for optimization
        />
      ))}
    </ul>
  )
...
WrappedListComponent.propTypes = {
  items: PropTypes.arrayOf(PropTypes.shape({ // Issue 6 : Syntax error - Should be arrayOf and shape instead of array and shapeOf
    text: PropTypes.string.isRequired,
  })),
};
